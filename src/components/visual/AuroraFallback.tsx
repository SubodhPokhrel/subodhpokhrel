...
export function AuroraFallback({ className }: AuroraFallbackProps) {
  return (
    ...
    >
      <div
        className="absolute top-1/3 left-1/2 size-[60vw] -translate-x-1/2 rounded-full opacity-30 blur-3xl"
        style={{
      ...
      />
      <div
        className="absolute top-[18%] right-[8%] size-[34vw] rounded-full opacity-25 blur-3xl"
        style={{
      ...
      />
      <div
        className="absolute bottom-[2%] left-[10%] size-[30vw] rounded-full opacity-20 blur-3xl"
